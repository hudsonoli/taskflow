...
class AccessTokenResponse(BaseModel):
    ...
    # Calculado ao vivo a partir de UsuarioCredencial.senha_deve_ser_alterada — nunca
    # confiar numa claim estática do JWT pra isso, porque a flag muda no meio da vida do token.
