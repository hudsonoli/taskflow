...
UsuarioEquipePapel = Literal["membro", "lider", "coordenador"]
UsuarioEquipeStatus = Literal["ativo", "encerrado"]
...
class UsuarioEquipeCreate(BaseModel):
    ...
    equipe_id: UUID = Field(alias="equipeId")
    papel: UsuarioEquipePapel
...
class UsuarioEquipeUpdate(BaseModel):
    papel: UsuarioEquipePapel | None = None
    principal: bool | None = None

    model_config = ConfigDict(populate_by_name=True, extra="forbid")


class UsuarioEquipeEncerrar(BaseModel):
