...
class Departamento(Base):
    ...
    __table_args__ = (
        ...
        CheckConstraint("trim(nome) <> ''", name="ck_departamentos_nome_nao_vazio"),
        CheckConstraint("trim(codigo_interno) <> ''", name="ck_departamentos_codigo_interno_nao_vazio"),
        ...
        Index("ix_departamentos_created_at", "created_at"),
    )
