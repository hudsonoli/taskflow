...
def create_grupo_cliente(
    ...
    current_user: Usuario = Depends(require_permissao("grupos_cliente.criar")),
...
def list_grupos_cliente(
    ...
    current_user: Usuario = Depends(require_permissao("grupos_cliente.visualizar")),
    db: Session = Depends(get_db),
):
...
def update_grupo_cliente(
    ...
    current_user: Usuario = Depends(require_permissao("grupos_cliente.editar")),
    db: Session = Depends(get_db),
):
    try:
...
def arquivar_grupo_cliente(
    ...
    current_user: Usuario = Depends(require_permissao("grupos_cliente.arquivar")),
    db: Session = Depends(get_db),
):
    try:
        existing = grupo_cliente_service.get_grupo_cliente(db, str(grupo_id))
