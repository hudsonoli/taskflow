...
def create_modelo_campanha(
    ...
    current_user: Usuario = Depends(require_permissao("modelos_campanha.criar")),
...
def list_modelos_campanha(
    ...
    current_user: Usuario = Depends(require_permissao("modelos_campanha.visualizar")),
    db: Session = Depends(get_db),
):
...
def update_modelo_campanha(
    ...
    current_user: Usuario = Depends(require_permissao("modelos_campanha.editar")),
    db: Session = Depends(get_db),
):
    try:
...
def arquivar_modelo_campanha(
    ...
    current_user: Usuario = Depends(require_permissao("modelos_campanha.arquivar")),
    db: Session = Depends(get_db),
):
    try:
        existente = modelo_campanha_service.get_modelo(db, str(modelo_id))
