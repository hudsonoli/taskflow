...
def create_categoria_peca(
    ...
    current_user: Usuario = Depends(require_permissao("categorias_peca.criar")),
...
def list_categorias_peca(
    ...
    current_user: Usuario = Depends(require_permissao("categorias_peca.visualizar")),
    db: Session = Depends(get_db),
):
...
def update_categoria_peca(
    ...
    current_user: Usuario = Depends(require_permissao("categorias_peca.editar")),
    db: Session = Depends(get_db),
):
    try:
...
def arquivar_categoria_peca(
    ...
    current_user: Usuario = Depends(require_permissao("categorias_peca.arquivar")),
    db: Session = Depends(get_db),
):
    try:
        existente = categoria_peca_service.get_categoria(db, str(categoria_id))
