...
// o backend exige. Não existe exclusão definitiva de SLA — só arquivar/restaurar.
export function ArquivarSlaRegraModal({
  open,
  nome,
  arquivando,
  onClose,
    ...
    <Modal open={open} onClose={onClose} maxWidthClassName="max-w-md">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              A regra não é apagada — some da listagem padrão, mas pode ser restaurada depois. O histórico de
      ...
      <div className="mt-4">
        <Textarea
          ...
          placeholder="Por que esta regra está sendo arquivada?"
          rows={3}
        />
      </div>
