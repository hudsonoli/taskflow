...
export function ArquivarEquipeModal({
  open,
  nome,
  arquivando,
  onClose,
    ...
    <Modal open={open} onClose={onClose} maxWidthClassName="max-w-md">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              A equipe não é apagada e os membros são preservados — a composição volta intacta se ela for
              restaurada.
            </p>
          </div>
        </div>
      ...
      <div className="mt-4">
        <Textarea
          ...
          placeholder="Por que esta equipe está sendo arquivada?"
          rows={3}
        />
      </div>
