...
export function HeaderSearch({ variant = "header" }: HeaderSearchProps) {
  ...
  if (variant === "sidebar") {
    return (
      <label className="flex h-8 w-full items-center gap-2 rounded-lg border border-zinc-200 bg-white px-2.5 text-[12px] text-zinc-500 transition-colors hover:bg-zinc-50">
