...
// o backend exige — e ele recusa motivo composto só de espaços, então o botão só habilita
// com conteúdo real.
export function ArquivarFornecedorModal({
  open,
  nome,
  arquivando,
  onClose,
    ...
    <Modal open={open} onClose={onClose} maxWidthClassName="max-w-md">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              O fornecedor não é apagado — o cadastro apenas sai da listagem e deixa de ser oferecido em novos
              vínculos. Pode ser restaurado depois.
            </p>
          </div>
        </div>
        <button
      ...
      <div className="mt-4">
        <Textarea
          ...
          placeholder="Por que este fornecedor está sendo arquivado?"
          rows={3}
        />
      </div>
