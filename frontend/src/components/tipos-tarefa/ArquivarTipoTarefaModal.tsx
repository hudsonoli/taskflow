...
// Arquivar = soft-delete permanente (docs/padrao-arquivamento.md). Motivo obrigatório porque
// o backend exige. Arquivar NÃO cascateia: itens de Modelo de Campanha que já referenciam
// este Tipo de Tarefa continuam como estão (FK sem CASCADE) — o que muda é que o diretório
// (só lista ativos) para de oferecê-lo em novas seleções.
export function ArquivarTipoTarefaModal({
  open,
  nome,
  arquivando,
  onClose,
    ...
    <Modal open={open} onClose={onClose} maxWidthClassName="max-w-md">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              O tipo de tarefa não é apagado. Itens de Modelo de Campanha que já o referenciam continuam como
              estão — apenas novas seleções ficam bloqueadas. Pode ser restaurado depois.
            </p>
          </div>
        </div>
        <button
      ...
      <div className="mt-4">
        <Textarea
          ...
          placeholder="Por que este tipo de tarefa está sendo arquivado?"
          rows={3}
        />
      </div>
