...
// porque o backend exige. Arquivar NÃO cascateia: usuários e equipes vinculados ficam
// como estão — o que muda é que novos vínculos passam a ser recusados.
export function ArquivarDepartamentoModal({
  open,
  nome,
  arquivando,
  onClose,
    ...
    <Modal open={open} onClose={onClose} maxWidthClassName="max-w-md">
        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <p className="mt-1 text-sm text-zinc-500 dark:text-zinc-400">
              O departamento não é apagado. As pessoas e equipes já vinculadas continuam como estão — apenas novos
              vínculos ficam bloqueados. Pode ser restaurado depois.
            </p>
          </div>
        </div>
        <button
      ...
      <div className="mt-4">
        <Textarea
          ...
          placeholder="Por que este departamento está sendo arquivado?"
          rows={3}
        />
      </div>
