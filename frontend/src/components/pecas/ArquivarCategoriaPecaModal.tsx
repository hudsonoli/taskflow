...
// Confirmação de "Arquivar" (soft-delete permanente, ver docs/padrao-arquivamento.md) — mesmo
// padrão de ExcluirGrupoClienteModal. Motivo obrigatório porque o backend exige
// (CategoriaPecaArquivar.motivoArquivamento). Peça já vinculada continua íntegra — nada é
// desassociado ao arquivar (ver PecaService._ensure_categoria_valida).
export function ArquivarCategoriaPecaModal({
  open,
  nome,
  arquivando,
  onClose,
    ...
    <Modal open={open} onClose={onClose} maxWidthClassName="max-w-md">
      ...
      <div className="mt-4">
        <Textarea
          ...
          placeholder="Por que esta categoria está sendo arquivada?"
          rows={3}
        />
      </div>
