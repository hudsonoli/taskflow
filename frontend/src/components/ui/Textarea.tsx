...
export function Textarea({ label, className, ...props }: TextareaProps) {
  return (
    <label className="block text-sm">
      ...
      <textarea
        className={clsx(
          "w-full rounded-xl border border-zinc-200/80 bg-zinc-50/70 px-3 py-2.5 text-sm text-zinc-900 outline-none transition placeholder:text-zinc-400 focus:border-indigo-300 focus:bg-white focus:shadow-sm",
