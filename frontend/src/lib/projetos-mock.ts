...
function createHistorico(seed: string, acao: string): ProjetoHistoricoEvento[] {
  return [
    {
      id: `hist-projeto-${seed}-1`,
      usuarioId: "user-1",
...
function createEquipe(seed: string): ProjetoEquipeMembro[] {
  return [
    {
      id: `membro-projeto-${seed}-1`,
      usuarioId: "user-2",
      nome: "Ana Costa",
      funcao: "Atendimento",
...
function createModeloCampanha(seed: string): ProjetoModeloCampanhaItem[] {
  return [
    {
...
export const projetosMock: Projeto[] = [
  {
    ...
    modeloCampanha: createModeloCampanha("p1"),
    equipe: createEquipe("p1"),
    arquivos: [],
    historico: createHistorico("p1", "Projeto criado"),
  },
  {
    id: "projeto-2",
    empresaId: EMPRESA_PADRAO_ID,
    ...
    modeloCampanha: createModeloCampanha("p2").slice(0, 1),
    equipe: createEquipe("p2").slice(0, 1),
    arquivos: [],
    historico: createHistorico("p2", "Projeto em planejamento"),
  },
  {
    id: "projeto-3",
    empresaId: EMPRESA_PADRAO_ID,
    ...
    modeloCampanha: [],
    equipe: createEquipe("p3"),
    arquivos: [],
    historico: createHistorico("p3", "Projeto concluído"),
  },
];
